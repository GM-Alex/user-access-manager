        ...
        <div class="postbox">
        	...
        	<div class="inside">
        		<p>
        		    ...
        		    <br/>
        		    <?php echo TXT_THANKS_TO; ?> Ron Harding, Zina, Erik Franz&eacute;n, J&uuml;rgen Wiesenbauer, Patric Schwarz, Mark LeRoy, Huska, macbidule, Helmut, -sCo-, <?php echo TXT_THANKS_OTHERS; ?>.
        		</p>
        	</div>
        </div>
    </div>
