        ...
        <div class="postbox">
        	...
        	<div class="inside">
        		<p>
        		    ...
        		    <br/>
        		    <?php echo TXT_UAM_THANKS_TO; ?> Jan, GeorgWP, Ron Harding, Zina, Erik Franz&eacute;n, Ivan Marevic, J&uuml;rgen Wiesenbauer, Patric Schwarz, Mark LeRoy, Huska, macbidule, Helmut, -sCo-, <?php echo TXT_UAM_THANKS_OTHERS; ?>.
        		</p>
        	</div>
        </div>
    </div>
