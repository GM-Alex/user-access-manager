...
/**
 * @coversDefaultClass \UserAccessManager\ObjectMembership\Type\TermMembershipHandler
 */
class TermMembershipHandlerTest extends ObjectMembershipHandlerTestCase
{
    /**
     * @group  unit
     * @covers ::__construct()
