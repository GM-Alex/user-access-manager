...
/**
 * @coversDefaultClass \UserAccessManager\ObjectMembership\Type\PostMembershipHandler
 */
class PostMembershipHandlerTest extends ObjectMembershipHandlerTestCase
{
    /**
     * @group  unit
     * @covers ::__construct()
