...
namespace UserAccessManager\Tests\Unit\Controller\Backend\Administration;
 ...
 * @coversDefaultClass \UserAccessManager\Controller\Backend\Administration\SettingsController
 */
class SettingsControllerTest extends UserAccessManagerTestCase
{
     ...
     */
    private function getWordpressWithPostTypesAndTaxonomies(
        $expectedPostTypes,
        $expectedTaxonomies
     ...
     * @covers ::getRedirectFormElement()
     * @covers ::addCustomPageRedirectFormElement()
     * @covers ::addCustomUrlRedirectFormElement()
     * @covers ::getPages()
     */
