 ...
 * @coversDefaultClass \UserAccessManager\Controller\Backend\ObjectMembership\PostObjectController
 */
class PostObjectControllerTest extends ObjectControllerTestCase
{
    ...
    public function testEditForm()
    {
        ...
        $expectedOutput = '!UserAccessManager\Controller\Backend\ObjectMembership\PostObjectController|'
        ...
        self::assertEquals(
            [
                ...
                'uam_user_groups' => [
                    ...
                    'input' => 'editFrom',
                    'editFrom' => '!UserAccessManager\Controller\Backend\ObjectMembership\PostObjectController|'
    ...
    public function testSaveObjectData()
    {
        ...
        $attachment = ['ID' => 3, 'title' => 'T'];
        self::assertEquals($attachment, $postObjectController->saveAttachmentData($attachment));
