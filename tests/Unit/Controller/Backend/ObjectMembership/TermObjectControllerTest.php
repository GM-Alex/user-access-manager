 ...
 * @coversDefaultClass \UserAccessManager\Controller\Backend\ObjectMembership\TermObjectController
 */
class TermObjectControllerTest extends ObjectControllerTestCase
{
    ...
    public function testEditForm()
    {
        ...
        $expected = 'content!UserAccessManager\Controller\Backend\ObjectMembership\TermObjectController|'
        ...
        $expectedOutput = '!UserAccessManager\Controller\Backend\ObjectMembership\TermObjectController|'
