 ...
 * @coversDefaultClass \UserAccessManager\Controller\Backend\ObjectMembership\UserObjectController
 */
class UserObjectControllerTest extends ObjectControllerTestCase
{
    ...
    public function testEditForm()
    {
        ...
        $expected = 'return!UserAccessManager\Controller\Backend\ObjectMembership\UserObjectController|'
        ...
        $expectedOutput = '!UserAccessManager\Controller\Backend\ObjectMembership\UserObjectController|'
