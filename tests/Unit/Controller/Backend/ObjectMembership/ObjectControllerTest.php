 ...
 * @coversDefaultClass \UserAccessManager\Controller\Backend\ObjectMembership\ObjectController
 */
class ObjectControllerTest extends ObjectControllerTestCase
{
    ...
    public function testEditForm()
    {
        ...
        $expected = '!UserAccessManager\Controller\Backend\ObjectMembership\ObjectController|'
        ...
        self::assertEquals(
            '!UserAccessManager\Controller\Backend\ObjectMembership\ObjectController|'
