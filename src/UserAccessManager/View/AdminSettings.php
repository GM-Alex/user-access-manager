        ...
        <table class="form-table">
            <table class="form-table">
                ...
                foreach ($aGroupParameters as $oGroupParameter) {
                    ...
                    <tr valign="top">
                        <?php
                        if ($oGroupParameter instanceof \UserAccessManager\Config\BooleanConfigParameter) {
                            ?>
                            ...
                            <td>
                                ...
                                <?php echo constant('TXT_UAM_'.strtoupper($oGroupParameter->getId()).'_DESC'); ?>
                            </td>
                            <?php
                            ...
                            <td>
                                <input id="uam_<?php echo $oGroupParameter->getId(); ?>"
                                       name="config_parameters[<?php echo $oGroupParameter->getId(); ?>]"
                                       value="<?php echo $oGroupParameter->getValue(); ?>"/><br/>
                                <?php echo constant('TXT_UAM_'.strtoupper($oGroupParameter->getId()).'_DESC'); ?>
                            </td>
                            <?php
                        }
                ...
                <tr valign="top">
                    ...
                    <td>
                        <label for="uam_hide_post_yes">
                            <input type="radio" id="uam_hide_post_yes" class="uam_hide_post" name="uam_hide_post"
                                   value="true" <?php
                        ...
                        <label for="uam_hide_post_no">
                            <input type="radio" id="uam_hide_post_no" class="uam_hide_post" name="uam_hide_post"
                                   value="false" <?php
            ...
            <table class="form-table" id="uam_post_settings">
                ...
                <tr valign="top">
                    ...
                    <td>
                        <label for="uam_show_post_content_before_more_yes">
                            <input type="radio" id="uam_show_post_content_before_more_yes"
                                   name="uam_show_post_content_before_more" value="true" <?php
                        ...
                        <label for="uam_show_post_content_before_more_no">
                            <input type="radio" id="uam_show_post_content_before_more_no"
                                   name="uam_show_post_content_before_more" value="false" <?php
                ...
                <tr valign="top">
                    ...
                    <td>
                        <label for="uam_hide_post_comment_yes">
                            <input id="uam_hide_post_comment_yes" type="radio" name="uam_hide_post_comment"
                                   value="true" <?php
                        ...
                        <label for="uam_hide_post_comment_no">
                            <input id="uam_hide_post_comment_no" type="radio" name="uam_hide_post_comment"
                                   value="false" <?php
                ...
                <tr valign="top">
                    ...
                    <td>
                        <input name="uam_post_comment_content" value="<?php echo $aUamOptions['post_comment_content']; ?>"/>
                        <br/>
                ...
                <tr valign="top">
                    ...
                    <td>
                        <label for="uam_post_comments_locked_yes">
                            <input id="uam_post_comments_locked_yes" type="radio" name="uam_post_comments_locked"
                                   value="true" <?php
                        ...
                        <label for="uam_post_comments_locked_no">
                            <input id="uam_post_comments_locked_no" type="radio" name="uam_post_comments_locked"
                                   value="false" <?php
                ...
                <tr>
                    ...
                    <td>
                        <label for="uam_hide_page_yes">
                            <input type="radio" id="uam_hide_page_yes" class="uam_hide_page" name="uam_hide_page"
                                   value="true" <?php
                        ...
                        <label for="uam_hide_page_no">
                            <input type="radio" id="uam_hide_page_no" class="uam_hide_page" name="uam_hide_page"
                                   value="false" <?php
            ...
            <table class="form-table" id="uam_page_settings">
                ...
                <tr valign="top">
                    ...
                    <td>
                        <label for="uam_hide_page_comment_yes">
                            <input id="uam_hide_page_comment_yes" type="radio" name="uam_hide_page_comment"
                                   value="true" <?php
                        ...
                        <label for="uam_hide_page_comment_no">
                            <input id="uam_hide_page_comment_no" type="radio" name="uam_hide_page_comment"
                                   value="false" <?php
                ...
                <tr valign="top">
                    ...
                    <td>
                        <input name="uam_page_comment_content" value="<?php echo $aUamOptions['page_comment_content']; ?>"/>
                        <br/>
                ...
                <tr valign="top">
                    ...
                    <td>
                        <label for="uam_page_comments_locked_yes">
                            <input id="uam_page_comments_locked_yes" type="radio" name="uam_page_comments_locked"
                                   value="true" <?php
                        ...
                        <label for="uam_page_comments_locked_no">
                            <input id="uam_page_comments_locked_no" type="radio" name="uam_page_comments_locked"
                                   value="false" <?php
                ...
                <tr>
                    ...
                    <td>
                        <label for="uam_lock_file_yes">
                            <input type="radio" id="uam_lock_file_yes" class="uam_lock_file" name="uam_lock_file"
                                   value="true" <?php
                        ...
                        <label for="uam_lock_file_no">
                            <input type="radio" id="uam_lock_file_no" class="uam_lock_file" name="uam_lock_file"
                                   value="false" <?php
                    ...
                    <tr>
                        ...
                        <td>
                            <label for="uam_lock_file_types_all">
                                <input type="radio" id="uam_lock_file_types_all" name="uam_lock_file_types"
                                       value="all" <?php
                                global $is_nginx;
                            ...
                            <label for="uam_lock_file_types_selected">
                                <input type="radio" id="uam_lock_file_types_selected" name="uam_lock_file_types"
                                       value="selected" <?php
                    ...
                    <tr>
                        ...
                        <td>
                            <label for="uam_file_pass_type_admin">
                                <input type="radio" id="uam_file_pass_type_admin" name="uam_file_pass_type"
                                       value="admin" <?php
                            ...
                            <label for="uam_file_pass_type_random">
                                <input type="radio" id="uam_file_pass_type_random" name="uam_file_pass_type"
                                       value="random" <?php
                ...
                <tr>
                    ...
                    <td>
                        <label for="uam_authors_has_access_to_own_yes">
                            <input type="radio" id="uam_authors_has_access_to_own_yes" name="uam_authors_has_access_to_own"
                                   value="true" <?php
                        ...
                        <label for="uam_authors_has_access_to_own_no">
                            <input type="radio" id="uam_authors_has_access_to_own_no" name="uam_authors_has_access_to_own"
                                   value="false" <?php
                ...
                <tr>
                    ...
                    <td>
                        <label for="uam_authors_can_add_posts_to_groups_yes">
                            <input type="radio" id="uam_authors_can_add_posts_to_groups_yes"
                                   name="uam_authors_can_add_posts_to_groups" value="true" <?php
                        ...
                        <label for="uam_authors_can_add_posts_to_groups_no">
                            <input type="radio" id="uam_authors_can_add_posts_to_groups_no"
                                   name="uam_authors_can_add_posts_to_groups" value="false" <?php
            ...
            <table class="form-table">
                ...
                <tr>
                    ...
                    <td>
                        <label for="uam_hide_empty_categories_yes">
                            <input type="radio" id="uam_hide_empty_categories_yes" name="uam_hide_empty_categories"
                                   value="true" <?php
                        ...
                        <label for="uam_hide_empty_categories_no">
                            <input type="radio" id="uam_hide_empty_categories_no" name="uam_hide_empty_categories"
                                   value="false" <?php
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <input name="uam_redirect_custom_url" value="<?php echo $aUamOptions['redirect_custom_url']; ?>"/>
                        <br/>
                ...
                <tr>
                    ...
                    <td>
                        <input name="uam_blog_admin_hint_text" value="<?php echo $aUamOptions['blog_admin_hint_text']; ?>"/>
                        <br/>
