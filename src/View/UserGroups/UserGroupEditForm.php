...
<form method="post" action="<?php echo $controller->getRequestUrl(); ?>">
    ...
    <table class="form-table">
        ...
        <tr class="form-field form-required">
            ...
            <td>
                <input size="40" value="<?php echo htmlentities($userGroup->getName() ?? '', ENT_QUOTES, 'UTF-8'); ?>"
        ...
        <tr class="form-field form-required">
            ...
            <td>
                <input size="40" value="<?php echo htmlentities($userGroup->getDescription() ?? '', ENT_QUOTES, 'UTF-8'); ?>"
        ...
        <tr class="form-field form-required">
            ...
            <td><input size="40" value="<?php echo htmlentities($userGroup->getIpRange() ?? '', ENT_QUOTES, 'UTF-8'); ?>"
