...
Here you found the changes in each version.
    ...
    2.3.10      2026/01/22  Fix other possible type error

    2.3.9       2026/01/19  Fix possible type error

    2.3.8       2025/12/12  Adjust logic wp cli command logic to prevent errors

    2.3.7       2025/12/10  Fix issue with MapPress

    2.3.6       2025/12/10  Improve type compatibility again...

    2.3.5       2025/12/10  Improve type compatibility again...

    2.3.4       2025/12/09  Improve type compatibility again

    2.3.3       2025/12/09  Improve compatibility again

    2.3.2       2025/12/09  Adjust wordpress wrapper

    2.3.1       2025/12/09  Fix possible type error
